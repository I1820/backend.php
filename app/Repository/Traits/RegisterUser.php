...
trait RegisterUser
{
    ...
    public function validateRegisterUser(Request $request)
    {
        $messages = [
            ...
            'password.min' => 'رمز عبور باید حداقل ۶ حرف باشد شامل حداقل یک عدد،یک حرف بزرگ، یک حرف کوچک و یک کاراکتر خاص باشد',
            'password.regex'=>'رمز عبور باید حداقل ۶ حرف باشد شامل حداقل یک عدد،یک حرف بزرگ، یک حرف کوچک و یک کاراکتر خاص باشد'
        ];
